...
<div class="breadcrumb">
	...
	<?php  
		...
		// echo strtotime($date_post);
		// echo $date_post;
		// $date_create = DateTime::createFromFormat('Y-m-d', $date_post);
			...
			<div class="col-md-9">
				...
				<section class="section-single">
					...
					<div class="info-post">
						<div class="row">
							<div class="col-md-8">
								<p class="by-author text-uppercase">ESCRITO POR<span class="author"> <?php echo  get_author_name(); ?></span></p>
							</div>
